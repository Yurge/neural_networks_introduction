...
# ---------- Первая модификация ГС: с каждой итерацией уменьшается шаг -----------
h0 = 0.1
point = a0
points = (a0,)
t = 4
...
# --------- Вторая модификация ГС "Adagrad": каждый градиент умножаем на разные числа ---------
point = a0
points = (a0,)
t = 40
...
# --------- Третий метод ГС "Adam": Адаптивные метод ---------
point = a0
points = (a0,)
e = 0.001				# Константа, близкая к 0
